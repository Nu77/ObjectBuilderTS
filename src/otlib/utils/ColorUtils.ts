export class ColorUtils {
    ...
    public static toARGB(color: number, alpha: number = 0xFF): number {
    ...
    public static HSItoRGB(color: number): number {
        const values = 7;
        const steps = 19;
        let H = 0;
        let S = 0;
    ...
    public static HSItoARGB(color: number): number {
        const rgb = ColorUtils.HSItoRGB(color);
        return ColorUtils.toARGB(rgb);
    }

    public static from8Bit(color: number): number {
