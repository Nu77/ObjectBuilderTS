...
export class MetadataFlags5 {
    ...
    public static readonly PICKUPABLE: number = 0x10;
    public static readonly HANGABLE: number = 0x11;
    public static readonly VERTICAL: number = 0x12;
    public static readonly HORIZONTAL: number = 0x13;
    public static readonly ROTATABLE: number = 0x14;
    public static readonly HAS_LIGHT: number = 0x15;
    public static readonly DONT_HIDE: number = 0x16;
    public static readonly TRANSLUCENT: number = 0x17;
    public static readonly HAS_OFFSET: number = 0x18;
    public static readonly HAS_ELEVATION: number = 0x19;
    public static readonly LYING_OBJECT: number = 0x1A;
    public static readonly ANIMATE_ALWAYS: number = 0x1B;
    public static readonly MINI_MAP: number = 0x1C;
    public static readonly LENS_HELP: number = 0x1D;
    public static readonly FULL_GROUND: number = 0x1E;
    public static readonly IGNORE_LOOK: number = 0x1F;
    public static readonly CLOTH: number = 0x20;
    public static readonly MARKET_ITEM: number = 0x21;
